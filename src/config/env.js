...
export const SESSION_TTL_SECONDS         = parseInt(process.env.SESSION_TTL_SECONDS         || '1800', 10)
export const CATEGORIES_TTL_SECONDS      = parseInt(process.env.CATEGORIES_TTL_SECONDS      || '3600', 10)
export const CUSTOMERS_TTL_SECONDS       = parseInt(process.env.CUSTOMERS_TTL_SECONDS       || '300',  10)
